 ...
 * @method
 * @chainable
 * @param {string|Buffer|Blob|File} file  A path to a file (in Node), or the file data as
 *                                        a Buffer, Blob or File object
...
WPRequest.prototype.file = function( file, name ) {
	if ( file ) {
		...
		// File global does not exist on Node 18.
		if ( ! name && ( isBuffer || ( isBlob && typeof file.name !== 'string' ) ) ) {
