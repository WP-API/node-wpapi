...
const filters = require( './var/filters' );
...
WPRequest.prototype._queryStr = function() {
	return filters.render( this._filters );
};

// Filter Aliases
WPRequest.prototype.category = filters.aliases.category;
WPRequest.prototype.name = filters.aliases.name;
WPRequest.prototype.search = filters.aliases.search;
