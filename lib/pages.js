...
/**
 * PagesRequest extends WPRequest to handle the /posts API endpoint
 *
 * @class PagesRequest
 * @constructor
 * @extends WPRequest
...
util.inherits( PagesRequest, WPRequest );
...
// All filter methods should be available to PagesRequest instances
extend( PagesRequest.prototype, filters.mixins );
