...
function reduceRouteComponents( routeObj, parentLevel, component, idx, components ) {
...
function reduceRouteTree( routes, namespaces, route ) {
	...
	routeComponents.reduce( reduceRouteComponents.bind( null, routeObj ), levels );
...
module.exports = {
	...
	_reduceTree: reduceRouteTree,
	_reduceComponents: reduceRouteComponents
};
