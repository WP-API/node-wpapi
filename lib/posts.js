...
/**
 * Specify that we are retrieving Post Meta, and optionally request a specific
 * post meta object by its ID (forces basic auth)
 *
 * @method meta
 * @chainable
 * @param {Number} [metaId] ID of the meta property to retrieve
